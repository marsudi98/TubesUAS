...
?>
        ...
        <div id="page-wrapper">
          <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Coach Candidate</h1>
            </div>
            <!-- /.col-lg-12 -->
          </div>
            <!-- /.row -->
                ...
                <tbody>
                  <?php foreach ($coach_list as $key) { ?>
                    <tr>
                      ...
                      <td>
                        <a href="<?php echo base_url("index.php/coach/update/".$key->candidate_id) ?>" class="btn btn-sm btn-link">Edit</a>
                        <a href="<?php echo base_url("index.php/coach/deleteData/".$key->candidate_id) ?>" class="btn btn-sm btn-link">Hapus</a>
                      </td>
                    </tr>
                  <?php } ?>
                </tbody>
