          ...
          <div class="row">
            ...
            <div class="row">
              <div class="col-lg-12">
                  ...
                  <a href="<?php echo base_url('index.php/admin/create') ?>" class="btn btn-primary my-3 float-right"><b>Tambah</b></a>
                  ...
                  <tbody>
                    <?php foreach ($pemain_list as $key) {
                      ...
                      <tr>
                        ...
                        <td>
                          <a href="<?php echo base_url("index.php/admin/update/".$key->id) ?>" class="btn btn-sm btn-link">Edit</a>
                          <a href="<?php echo base_url("index.php/admin/deleteData/".$key->id) ?>" class="btn btn-sm btn-link">Hapus</a>
                        </td>
                      </tr>
                    <?php } ?>
                  </tbody>
